---
permalink: /crossplane/1.19/pkg/v1beta1/function/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPackage(package)`](#fn-specwithpackage)
  ...
  * [`fn withRevisionActivationPolicy(revisionActivationPolicy)`](#fn-specwithrevisionactivationpolicy)
...
### fn spec.withRevisionActivationPolicy

```ts
withRevisionActivationPolicy(revisionActivationPolicy)
```
